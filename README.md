...
## Papers
  ...
  - ***Deep Successor Reinforcement Learning*** [[arXiv 2016]](https://arxiv.org/abs/1606.02396)
      ...
      - Section 3.3 is a little tricky. The m_sa represents the **feature of the future occupancy**, so m_sa×W becomes the future accumulated reward (Q-value). The ∅(s)×W is the **immediate reward**. Therefore, m_sa = φ(s) + γE[m_st+1a'] :point_right: eq.6
